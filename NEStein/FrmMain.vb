Public Class FrmMain
    ...
    Private Sub MnuRecordMovie_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub MnuRecordSnd_Click(sender As Object, e As EventArgs)
    ...
    Private Sub AjudaToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AjudaToolStripMenuItem.Click
        MsgBox("Original by: gdkchan (GitHub)" + vbNewLine + "Modifications and Improvements by: MitchellUrgero(GitHub/urgero.org)" + vbNewLine + "Open Source GPL License" + vbNewLine + "Cloned Using GitHub for Windows!")
    End Sub
